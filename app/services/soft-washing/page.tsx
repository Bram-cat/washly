...
import { Phone, CheckCircle, Home, ArrowRight, Star, Clock, Shield, Droplets, Leaf } from 'lucide-react';
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden gradient-mesh">
        ...
        <div className="container relative z-10 mx-auto px-6 sm:px-8 lg:px-12 text-center max-w-6xl py-28">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-slate-600 mb-12 max-w-3xl mx-auto font-medium leading-relaxed">
            Gentle yet effective cleaning with
            <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent font-bold"> low pressure </span>
            for delicate surfaces
          </p>

          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {['Safe & Gentle', 'Long-Lasting Results', 'Eco-Friendly', 'No Surface Damage'].map((feature, i) => (
              <div
                key={i}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-28">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-lg text-slate-600 leading-relaxed">
                  Soft washing uses <span className="font-bold text-slate-800">low-pressure water</span> combined with specialized cleaning solutions to safely remove dirt, algae, mold, and mildew from delicate surfaces. It's <span className="font-bold text-blue-600">perfect for materials</span> that could be damaged by high-pressure washing.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Our <span className="font-bold text-slate-800">eco-friendly cleaning solutions</span> kill organic growth at the root, providing <span className="font-bold text-blue-600">longer-lasting results</span> than pressure washing alone while keeping your surfaces safe.
                </p>
              </div>

              <div className="grid grid-cols-2 gap-4 pt-6">
                {[
                  { icon: Droplets, label: 'Low-Pressure Safe', color: 'from-blue-500 to-blue-600' },
                  { icon: Leaf, label: 'Eco-Friendly Solutions', color: 'from-blue-600 to-blue-700' },
                  { icon: Shield, label: 'Fully Insured', color: 'from-slate-600 to-slate-700' },
                  { icon: Star, label: 'Long-Lasting Clean', color: 'from-blue-500 to-blue-600' },
                ].map((item, i) => (
                  <div
                    key={i}
            ...
            <div className="relative group">
              ...
              <div className="relative h-[600px] rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/20 border-4 border-white group-hover:scale-[1.02] transition-transform duration-500">
                <Image
                  src="/4.png"
                  alt="Professional soft washing in progress"
                  fill
          ...
          <div className="mb-28">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Gentle cleaning perfect for delicate materials
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'Vinyl Siding', desc: 'Safe cleaning without damage' },
                { name: 'Stucco', desc: 'Preserve texture and finish' },
                { name: 'Wood Surfaces', desc: 'Gentle on natural materials' },
                { name: 'Painted Surfaces', desc: 'Won\'t strip or damage paint' },
                { name: 'Roof Shingles', desc: 'Extend roof lifespan' },
                { name: 'Decks', desc: 'Clean without splintering' },
                { name: 'Fences', desc: 'Protect wood and finishes' },
                { name: 'Outdoor Furniture', desc: 'Restore appearance safely' },
              ].map((item, index) => (
                <Card
                  key={index}
          ...
          <div className="relative">
            ...
            <div className="relative glass-effect rounded-[3rem] p-12 md:p-16 lg:p-20 border border-blue-200/50 shadow-2xl">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                  Gentle cleaning with powerful, long-lasting results
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: 'Low-pressure cleaning prevents damage to delicate materials like vinyl siding, painted surfaces, and wood, preserving their integrity and appearance.',
                    gradient: 'from-blue-500 to-blue-600',
                  },
                  {
                    title: 'Longer Results',
                    desc: 'Cleaning solutions kill organic growth at the root, preventing rapid regrowth and keeping surfaces cleaner for much longer than pressure washing alone.',
                    gradient: 'from-blue-600 to-blue-700',
                  },
                  {
                    title: 'Eco-Friendly',
                    desc: 'We use biodegradable, environmentally safe cleaning solutions that are effective yet gentle on plants, landscaping, and the ecosystem.',
                    gradient: 'from-slate-600 to-slate-700',
                  },
                  {
                    title: 'Cost-Effective',
                    desc: 'Prevent costly repairs and replacements by using the appropriate cleaning method. Soft washing extends the life of your exterior surfaces.',
                    gradient: 'from-blue-500 to-blue-600',
                  },
                ].map((benefit, i) => (
                  <Card
      ...
      <section className="relative py-28 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-6 sm:px-8 lg:px-12 max-w-5xl text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
            Contact us today for a <span className="text-white font-bold">free, no-obligation quote</span> on professional soft washing services
          </p>
