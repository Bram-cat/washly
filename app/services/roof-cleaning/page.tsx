...
import { Phone, CheckCircle, Home, ArrowRight, Star, Clock, Shield, Droplets, Zap, Eye } from 'lucide-react';
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden gradient-mesh">
        ...
        <div className="container relative z-10 mx-auto px-6 sm:px-8 lg:px-12 text-center max-w-6xl py-28">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-slate-600 mb-12 max-w-3xl mx-auto font-medium leading-relaxed">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent font-bold"> expert soft washing </span>
            that protects your investment
          </p>

          {/* Feature Pills */}
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {['Moss Removal', 'Safe Soft Washing', 'Fully Insured', 'Warranty Safe'].map((feature, i) => (
              <div
                key={i}
          ...
          <div className="mt-16 flex flex-wrap justify-center items-center gap-8 opacity-70">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-slate-600">Professional Service</span>
            </div>
            <div className="h-6 w-px bg-slate-300"></div>
            <div className="flex items-center gap-2">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-lg text-slate-600 leading-relaxed">
                  Moss, algae, and lichen can <span className="font-bold text-slate-800">significantly reduce your roof's lifespan</span> and affect your home's curb appeal. Our professional roof cleaning service safely removes these harmful growths using <span className="font-bold text-blue-600">specialized soft washing techniques</span>.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  We use <span className="font-bold text-slate-800">gentle, low-pressure methods</span> that will not damage your shingles while effectively eliminating organic growth and restoring your roof's appearance.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-6">
                {[
                  { icon: Droplets, label: 'Soft Wash Safe', color: 'from-blue-500 to-blue-600' },
                  { icon: Zap, label: 'Fast Service', color: 'from-blue-600 to-blue-700' },
                  { icon: Shield, label: 'Fully Insured', color: 'from-slate-600 to-slate-700' },
                  { icon: Eye, label: 'Warranty Safe', color: 'from-blue-500 to-blue-600' },
                ].map((item, i) => (
                  <div
                    key={i}
              ...
              <div className="absolute -bottom-6 -left-6 glass-effect p-6 rounded-2xl border border-blue-200/50 shadow-2xl">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-slate-600">Roofs Cleaned</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative glass-effect rounded-[3rem] p-12 md:p-16 lg:p-20 border border-blue-200/50 shadow-2xl">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                  Protect your investment and extend your roof's lifespan
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  { title: 'Extended Roof Life', desc: 'Remove harmful organisms that deteriorate shingles and reduce roof lifespan.', gradient: 'from-blue-500 to-blue-600' },
                  { title: 'Improved Energy Efficiency', desc: 'Clean roofs reflect more sunlight, helping keep your home cooler in summer.', gradient: 'from-blue-600 to-blue-700' },
                  { title: 'Enhanced Curb Appeal', desc: 'Restore your roof\'s original color and boost your home\'s overall appearance.', gradient: 'from-slate-600 to-slate-700' },
                  { title: 'Prevent Damage', desc: 'Stop moss and algae from lifting shingles and causing leaks.', gradient: 'from-blue-500 to-blue-600' },
                  { title: 'Maintain Warranty', desc: 'Some roof warranties require regular cleaning and maintenance.', gradient: 'from-blue-600 to-blue-700' },
                  { title: 'Increase Property Value', desc: 'A clean, well-maintained roof is a major selling point.', gradient: 'from-slate-600 to-slate-700' },
                ].map((benefit, i) => (
                  <Card
                    key={i}
                  ...
                  >
                    ...
                    <CardContent className="relative p-8">
                      <div className="flex items-start gap-4">
                        <div className={`flex-shrink-0 p-3 bg-gradient-to-br ${benefit.gradient} rounded-xl shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500`}>
      ...
      <section className="relative py-28 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-6 sm:px-8 lg:px-12 max-w-5xl text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
            Schedule professional roof cleaning and <span className="text-white font-bold">extend your roof's life</span> for years to come
          </p>
